...
namespace Protege_PYA.Controllers
{
    public class AdministradorController : Controller
    {
        ...
        public AdministradorController(ProtegePyaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Usuario,Pass")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Usuario,Pass")] Administrador administrador)
        {
